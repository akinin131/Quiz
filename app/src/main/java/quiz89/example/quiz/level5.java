...
public class level5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.levels5);
        SoundPool soundPool;
        int sound1, sound2;
        ...
        imageView.setImageResource(R.drawable.fifelevel_diologstart);
        TextView textView1 = dialog.findViewById(R.id.textdescription);
        textView1.setText(R.string.textlevel5start);
       ...
       btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(level5.this, GamesLevel.class);
        ...
        textView2.setText(R.string.textlevel5End);
...
//        btnclose = findViewById(R.id.btncloseee);
      ...
      //  numRight = random.nextInt(10);
        sloi1.setImageResource(array.images5[numLeft]);
        textLeft.setText(array.text5[numLeft]);
        ...
        sloi2.setImageResource(array.images5[numRight]);
        textRight.setText(array.text5[numRight]);
