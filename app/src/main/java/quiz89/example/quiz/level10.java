...
public class level10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.levels10);
        SoundPool soundPool;
        int sound1, sound2;
        ...
        imageView.setImageResource(R.drawable.diologstart9);
        TextView textView1 = dialog.findViewById(R.id.textdescription);
        textView1.setText(R.string.textlevel10start);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(level10.this, GamesLevel.class);
        ...
        textView2.setText(R.string.textlevel10End);
...
//        btnclose = findViewById(R.id.btncloseee);
        ...
        final Animation animation = AnimationUtils.loadAnimation(level10.this, R.anim.alpha);
        // Подключаем анимацию конец
        numLeft = random.nextInt(10);
        //  numRight = random.nextInt(10);
        sloi1.setImageResource(array.images10[numLeft]);
        textLeft.setText(array.text10[numLeft]);
        ...
        sloi2.setImageResource(array.images10[numRight]);
        textRight.setText(array.text10[numRight]);
