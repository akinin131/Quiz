...
public class level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.twolevel_diologstart);
        TextView textView1 = dialog.findViewById(R.id.textdescription);
        textView1.setText(R.string.textlevel2string);
       ...
       btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(level2.this, GamesLevel.class);
        ...
        textView2.setText(R.string.textlevel3string);
...
//        btnclose = findViewById(R.id.btncloseee);
      ...
      //  numRight = random.nextInt(10);
        sloi1.setImageResource(array.images[numLeft]);
        ...
        sloi2.setImageResource(array.images[numRight]);
