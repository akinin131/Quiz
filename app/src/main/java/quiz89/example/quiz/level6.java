...
public class level6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.levels6);
        SoundPool soundPool;
        int sound1, sound2;
        ...
        imageView.setImageResource(R.drawable.sixlevel_diologstart);
        TextView textView1 = dialog.findViewById(R.id.textdescription);
        textView1.setText(R.string.textlevel6start);
       ...
       btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(level6.this, GamesLevel.class);
        ...
        textView2.setText(R.string.textlevel6End);
...
//        btnclose = findViewById(R.id.btncloseee);
        ...
        Button btncontinue1End = dialogEnd.findViewById(R.id.btncloseee);
        ...
        final Animation animation = AnimationUtils.loadAnimation(level6.this, R.anim.alpha);
            // Подключаем анимацию конец
        numLeft = random.nextInt(18);
      //  numRight = random.nextInt(10);
        sloi1.setImageResource(array.images6[numLeft]);
        textLeft.setText(array.text6[numLeft]);
        ...
        sloi2.setImageResource(array.images6[numRight]);
        textRight.setText(array.text6[numRight]);
