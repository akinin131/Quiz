...
public class level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.levels3);

        imageView1.setImageResource(R.drawable.pole);
        ...
        imageView.setImageResource(R.drawable.freelevel_diologstart);
        TextView textView1 = dialog.findViewById(R.id.textdescription);
        textView1.setText(R.string.textlevel3start);

        btnclose = findViewById(R.id.btncloseee);

        LinearLayout linearLayout;
        linearLayout = dialog.findViewById(R.id.dialogon);
        linearLayout.setBackgroundResource(R.drawable.polediolog);
       ...
       btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(level3.this, GamesLevel.class);
        ...
        textView2.setText(R.string.textlevel3End);
        LinearLayout linearLayout1;
        linearLayout1 = dialogEnd.findViewById(R.id.dialogonEnd);
        linearLayout1.setBackgroundResource(R.drawable.polediolog);
...
//        btnclose = findViewById(R.id.btncloseee);
      ...
      //  numRight = random.nextInt(10);
        sloi1.setImageResource(array.images3[numLeft]);
        textLeft.setText(array.text2[numLeft]);

        numRight = random.nextInt(20);

        while (array.oneTwo[numLeft] == array.oneTwo[numRight]){
            numRight = random.nextInt(20);
        }

        sloi2.setImageResource(array.images3[numRight]);
                ...
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    ...
                    // Условие касание картинки - начало
                        if(motionEvent.getAction()==MotionEvent.ACTION_DOWN){
                            ...
                            if (array.oneTwo[numLeft] < array.oneTwo[numRight]){
