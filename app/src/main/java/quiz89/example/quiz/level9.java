...
public class level9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.levels9);
        SoundPool soundPool;
        int sound1, sound2;
        ...
        textView1.setText(R.string.textlevel9start);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(level9.this, GamesLevel.class);
        ...
        textView2.setText(R.string.textlevel9End);
...
//        btnclose = findViewById(R.id.btncloseee);
        ...
        final Animation animation = AnimationUtils.loadAnimation(level9.this, R.anim.alpha);
        // Подключаем анимацию конец
        numLeft = random.nextInt(10);
        //  numRight = random.nextInt(10);
        sloi1.setImageResource(array.images9[numLeft]);
        textLeft.setText(array.text9[numLeft]);
        ...
        sloi2.setImageResource(array.images9[numRight]);
        textRight.setText(array.text9[numRight]);
