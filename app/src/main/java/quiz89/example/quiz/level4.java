...
public class level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.levels4);
        SoundPool soundPool;
        int sound1, sound2;
        ImageView imageView1 = findViewById(R.id.imageView3);
        imageView1.setImageResource(R.drawable.ferma);
        ...
        imageView.setImageResource(R.drawable.fourlevel_diologstart);
        TextView textView1 = dialog.findViewById(R.id.textdescription);
        textView1.setText(R.string.textlevel4start);

        LinearLayout linearLayout;
        linearLayout = dialog.findViewById(R.id.dialogon);
        linearLayout.setBackgroundResource(R.drawable.fermadiolog);
       ...
       btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(level4.this, GamesLevel.class);
        ...
        textView2.setText(R.string.textlevel4End);

        LinearLayout linearLayout1;
        linearLayout1 = dialogEnd.findViewById(R.id.dialogonEnd);
        linearLayout1.setBackgroundResource(R.drawable.fermadiolog);
...
//        btnclose = findViewById(R.id.btncloseee);
      ...
      //  numRight = random.nextInt(10);
        sloi1.setImageResource(array.images4[numLeft]);
        ...
        sloi2.setImageResource(array.images4[numRight]);
        ...
        sloi2.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if(motionEvent.getAction()==MotionEvent.ACTION_DOWN){
                    //если коснулся картинки - начло
                    sloi1.setEnabled(false); // блокируем левую картинку
                    if (numLeft > numRight){
