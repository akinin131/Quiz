...
public class level11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.levels8);
        ...
        imageView.setImageResource(R.drawable.level8diologstart);
        TextView textView1 = dialog.findViewById(R.id.textdescription);
        textView1.setText(R.string.textlevel11start);

        LinearLayout linearLayout;
        linearLayout = dialog.findViewById(R.id.dialogon);
        linearLayout.setBackgroundResource(R.drawable.morediolog);
       ...
       btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(level11.this, GamesLevel.class);
        ...
        textView2.setText(R.string.textlevel11End);
...
//        btnclose = findViewById(R.id.btncloseee);
        ...
        btncontinue1End.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(level11.this, level4.class);
                startActivity(intent);
                finish();
        ...
        final Animation animation = AnimationUtils.loadAnimation(level11.this, R.anim.alpha);
            // Подключаем анимацию конец
        numLeft = random.nextInt(20);
      //  numRight = random.nextInt(10);
        sloi1.setImageResource(array.images11[numLeft]);
        textLeft.setText(array.text11[numLeft]);

        numRight = random.nextInt(20);

        while (array.level11oneTwo[numLeft] == array.level11oneTwo[numRight]){
            numRight = random.nextInt(20);
        }

        sloi2.setImageResource(array.images11[numRight]);
        textRight.setText(array.text11[numRight]);
                ...
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    ...
                    // Условие касание картинки - начало
                        if(motionEvent.getAction()==MotionEvent.ACTION_DOWN){
                            ...
                            if (array.level11oneTwo[numLeft] < array.level11oneTwo[numRight]){
