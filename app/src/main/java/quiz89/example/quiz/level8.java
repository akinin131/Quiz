...
public class level8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView1.setText(R.string.textlevel8start);
       ...
       btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(level8.this, GamesLevel.class);
...
//        btnclose = findViewById(R.id.btncloseee);
        ...
        final Animation animation = AnimationUtils.loadAnimation(level8.this, R.anim.alpha);
            // Подключаем анимацию конец
        numLeft = random.nextInt(20);
      //  numRight = random.nextInt(10);
        sloi1.setImageResource(array.images8[numLeft]);
        textLeft.setText(array.text8[numLeft]);

        numRight = random.nextInt(20);

        while (array.level8oneTwo[numLeft] == array.level8oneTwo[numRight]){
            numRight = random.nextInt(20);
        }

        sloi2.setImageResource(array.images8[numRight]);
        textRight.setText(array.text8[numRight]);
                ...
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    ...
                    // Условие касание картинки - начало
                        if(motionEvent.getAction()==MotionEvent.ACTION_DOWN){
                            ...
                            if (array.level8oneTwo[numLeft] < array.level8oneTwo[numRight]){
